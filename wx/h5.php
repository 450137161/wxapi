...
/** 请填写以下配置信息 */
$mchid = '1507690581';          //微信支付商户号 PartnerID 通过微信支付商户资料审核后邮件发送
$appid = 'wx305933be38c5f779';  //微信支付申请对应的公众号的APPID
$appKey = 'chongqingshidejurenheyouxiangong';   //微信支付申请对应的公众号的APP Key
$apiKey = 'chongqingshidejurenheyouxiangong';   //https://pay.weixin.qq.com 帐户设置-安全设置-API安全-API密钥-设置API密钥
